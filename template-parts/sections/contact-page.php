  ...
  <div class="contact-page-wrapper">
    <div class="contact-page-header">
              ...
              <div id="<?php echo esc_attr($tpl_id); ?>" class="team-modal-template contact-team-modal-template" hidden>
                <div class="team-modal__inner">
                  <div class="team-modal__text">
                    ...
                    <?php if ($popup_text): ?><div class="team-modal__content contact-team-modal__content-subtitle"><?php echo wp_kses_post($popup_text); ?></div><?php endif; ?>
                    <?php if ($contact_form): ?>
      ...
      <div class="team-modal" aria-hidden="true">
        ...
        <div class="team-modal__dialog contact-team-modal__dialog" role="dialog" aria-modal="true" aria-label="team-modal-title">
        ...
        <?php if (have_rows('contact_info')): ?>
          <ul class="hb-info__list contact-hb-info__list">
            <?php while (have_rows('contact_info')): the_row();
              ...
              $get = get_sub_field('get_directions_url');
              if ($info_link && !empty($info_link['url'])): ?>
                <li class="hb-info__item contact-page-hb-info__item <?php if ($get): ?> contact-page-hb-info__item-address <?php endif; ?>">
                  ...
                  <?php else : ?>
                    <p
                      class="hb-info__link contact-page-hb-info__link contact-page-hb-info__link-address">
                      <?php echo esc_html($info_link['title'] ?: ''); ?>
                      <?php $get = get_sub_field('get_directions_url'); ?>
                      <?php if ($get): ?>
