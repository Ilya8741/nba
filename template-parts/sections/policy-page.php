<div class="policy-page">
    <div class="policy-page-wrapper">
        <h1 class="policy-page-title" data-aos="fade-right" data-aos-duration="600" data-aos-delay="100" data-aos-easing="ease-out"><?php the_sub_field('title'); ?></h1>
                <div class="policy-page-subtitle" data-aos="fade-left" data-aos-duration="600" data-aos-delay="100" data-aos-easing="ease-out">
                     <?php
                $subtitle = get_sub_field('subtitle');
                if ($subtitle) {
                    echo apply_filters('the_content', $subtitle);
                }
                ?>
                </div>
